                ...
                <Observer onChange={handleIntersection}>
                    <div className="row">
                        <div className="col-md-4" style={{marginTop: 16}}>
                            <TrainingCard route="/training#personaltraining" image={personalTraining} title={'Personal Training'} text={'Clients receive customized programs based on rigorous initial evaluations, in order to help their bodies move more efficiently to prevent injuries and to establish a healthier lifestyle.'}/>
                        </div>
                        <div className="col-md-4" style={{marginTop: 16}}>
                            <TrainingCard route="/training#athletes" image={athleteClasses} title={'Athlete Strength & Conditioning'} text={'Athlete groups ages 11-22 are brought through a specific warm-up and customized programming, corrective exercises and sports performance exercises based on their goals, sports and continual evaluations.'}/>
                        </div>
                        <div className="col-md-4" style={{marginTop: 16}}>
