...
import beachhouse2 from "../assets/images/beach_house2.jpg";
        ...
        <ContainerPanel id="beachhouse">
            <div className="row" style={{marginTop: 24}}>
                ...
                <div className="col-md-6" style={{paddingBottom: 64}}>
                    <div style={{width: '100%', textAlign: 'center', height: '100%', marginBottom: 64}} className="card">
                        <img src={beachhouse4} style={{width: '100%', height: '100%', objectFit: 'cover'}}/>
                    </div>
                </div>
            </div>
            <div style={{width: '100%', textAlign: 'center'}} className="card">
                <img src={natickbeachhouse} style={{width: '100%', height: 'auto', objectFit: 'cover'}}/>
            </div>
            <div className="row" style={{marginTop: 24}}>
                <div className="col-md-6">
                    <div style={{width: '100%', textAlign: 'center'}} className="card">
                        <img src={entrance} style={{width: '100%', height: 'auto', objectFit: 'cover'}}/>
                    </div>
                </div>
                <div className="col-md-6">
                    <div style={{width: '100%', textAlign: 'center'}} className="card">
                        <img src={beachhouse2} style={{width: '100%', height: 'auto', objectFit: 'cover'}}/>
                    </div>
                </div>
            </div>
            <div style={{width: '100%', textAlign: 'center'}} className="card">
